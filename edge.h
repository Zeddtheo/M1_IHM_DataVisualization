 ...
 * La méthode adjust() est utilisée pour ajuster la position des nœuds source et destination sur l'arête.
 * La méthode paint() est utilisée pour dessiner l'arête en utilisant les informations stockées.
...
public:
    ...
    /**
     * @brief Est ce que le noeud est selectionné
     */
    bool isSelected;

    /**
     * @brief Modifier la couleur du noeud
     * @param La couleur que l'on veut mettre
     */
...
protected:
    ...
    /**
     * @brief Est déclenché quand on clique dessus et applique soit le mouvement si clique gauche soit la sélection si clique droit
     * @param event
     */
